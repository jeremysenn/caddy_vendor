...
#  after_create :transfer_web_service_call
  ...
  after_create :send_member_sms_notification
...
#  validates_numericality_of :caddy_fee_cents, :greater_than => 0
  ...
  validates :caddy_tip_cents, numericality: { greater_than_or_equal_to: 0, less_than_or_equal_to: 9900,  message: "Tip must be under $100" }, :allow_nil => true
